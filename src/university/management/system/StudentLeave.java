...
public class StudentLeave extends JFrame implements ActionListener {
    ...
    StudentLeave(){
        ...
        // heading
        heading2 = new JLabel("Search by PRN: ");
        heading2.setBounds(60,100,150,20);
        heading2.setFont(new Font("Tahoma",Font.PLAIN,18));
        add(heading2);
        
        cPrn = new Choice();
        cPrn.setBounds(60,130,200,20);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            if (ae.getSource() == submit ){
                ...
                String prnNo = cPrn.getSelectedItem();
                String date = ( (JTextField) dcdate.getDateEditor().getUiComponent()).getText();
                String duration = cTime.getSelectedItem();
                
                String query = "INSERT INTO student_leave VALUES ('"+prnNo+"','"+date+"','"+duration+"' )";
